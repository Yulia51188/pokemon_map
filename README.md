...
### Данные о покемонах и местах их появления

Через админку сайта можно добавить различные типы покемонов, для каждого обязательно указать имя на русском. Чтобы покемон отображался на карте необходимо загрузить файл с его изображением. Для полного отображения на странице покемона можно добавить описание, имя на английском и японском.

Для появления и исчезновения покемона через админку сайта нужно добавить записи, сожержащие тип покемона, координаты, время появления и исчезновения. Дополнительно можно назначить покемону уровень, очки здоровья и другие характеристики.
